...
class MessageLogCell: UICollectionViewCell {
    ...
    static let blueColor = UIColor.colorWithRGBHex(hex: 0x60C3FF)
...
//        textView.widthAnchor.constraintEqualToConstant(200).active = true
        ...
        messageTimeLabel.topAnchor.constraint(equalTo: bubbleView.bottomAnchor, constant: 1).isActive = true
        messageTimeLabel.widthAnchor.constraint(equalTo: textView.widthAnchor).isActive = true
        messageTimeLabel.textAlignment = .right
        messageTimeLabel.heightAnchor.constraint(equalToConstant: 8)
    }
